...
You can download a copy of this activity from the below link to make it easier to follow along with:
[Download Activity](https://advancedjs.codingcredentials.com/Lesson3/3.2.1/Lesson3.2Activity.pdf "Download Activity")
...
```
## Step 4 @unplugged
Return to the Minecraft world to run your code by clicking the Green play button and entering the text sayHello in the chat window.
...
## Step 13
Return to your Minecraft world and run the sayHello command again and check that the Agent now moves 5 blocks to the right.
...
```
## Step 17
Return to your Minecraft world and run the sayHello command again and take note of what happens.
